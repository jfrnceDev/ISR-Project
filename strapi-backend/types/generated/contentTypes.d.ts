...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    legalLinks: Schema.Attribute.Component<'legal-links.legal-links', true>;
    locale: Schema.Attribute.String;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutSectionContent: Schema.Attribute.String;
    ...
    heroButton1: Schema.Attribute.String;
    heroButton2: Schema.Attribute.String;
    ...
    homepageImages: Schema.Attribute.Component<
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    carouselTicker: Schema.Attribute.Component<
      'carousel-ticker.carousel-ticker',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    headerLinks: Schema.Attribute.Component<'header-links.header-links', true>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaSection: Schema.Attribute.Component<'cta-section.cta-section', false>;
    description: Schema.Attribute.Blocks;
    faqSection: Schema.Attribute.Component<'faq-section.faq-section', true>;
    ...
    providerOptions: Schema.Attribute.Component<
...
export interface ApiPaymentPagePaymentPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Blocks;
    errorMessage: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    seo: Schema.Attribute.Component<'shared.seo', false>;
    subtitle: Schema.Attribute.String;
    successMessage: Schema.Attribute.Blocks;
